...
RSpec.describe Irb::Autosuggestions::LineEditorPatch do
  ...
  # rubocop:disable Metrics/MethodLength, Metrics/AbcSize, Metrics/CyclomaticComplexity, Metrics/PerceivedComplexity, RSpec/InstanceVariable
  ...
  # rubocop:enable Metrics/MethodLength, Metrics/AbcSize, Metrics/CyclomaticComplexity, Metrics/PerceivedComplexity, RSpec/InstanceVariable
  ...
  def with_config(value)
    ...
    IRB.conf[described_class::CONFIG_KEY] = value
    yield
  ensure
